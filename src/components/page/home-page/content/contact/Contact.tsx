...
const Contact = () => {
  ...
  const renderPc = (
    <ContactStyle>
      <TitleDivider orientation={"right"}>Contact to me</TitleDivider>
      <Row className="d-flex container">
        <Col span={14} className="animation">
          <Rive src={"/assets/astronaut_with_moon_final.riv"} />
        </Col>
        <Col span={10}>
          <Flex vertical className="send-message">
            <Typography.Text className="description">
              {description}
            </Typography.Text>
            <Typography.Text className="icon-email">
              <MailOutlined /> {email}
            </Typography.Text>
            <Form
